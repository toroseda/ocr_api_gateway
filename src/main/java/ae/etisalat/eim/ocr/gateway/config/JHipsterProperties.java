...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "OcrApiGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "OcrApiGateway API";

        private String description = "OcrApiGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "OcrApiGateway";
