(function() {
    ...
    ServiceRespOcrDataDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'DataUtils', 'entity', 'ServiceResp', 'ServiceWf'];

    function ServiceRespOcrDataDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, DataUtils, entity, ServiceResp, ServiceWf) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('ocrApiGatewayApp:serviceRespUpdate', result);
