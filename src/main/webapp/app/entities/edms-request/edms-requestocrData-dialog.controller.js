(function() {
    ...
    EdmsRequestOcrDataDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'EdmsRequest', 'OcrSession', 'RequestWf', 'EdmsResponse'];

    function EdmsRequestOcrDataDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, EdmsRequest, OcrSession, RequestWf, EdmsResponse) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('ocrApiGatewayApp:edmsRequestUpdate', result);
